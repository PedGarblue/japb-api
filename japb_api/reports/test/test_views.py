...
class TestReportAccountViews(APITestCase):
    def setUp(self):
        ...
        self.account = Account.objects.create(
            name="Test Account", currency=self.currency, user=self.user
        )
        self.data = {
    ...
    def test_api_lists_reports_by_account(self):
        account2 = Account.objects.create(
            name="Test Account 2", currency=self.currency, user=self.user
        )
        ...
        response = self.client.get(
            reverse("reports-list"), {"account": self.account.id}, format="json"
        )
    ...
    def test_api_lists_and_sorts_reports_by_from_date(self):
        ...
        response = self.client.get(
            reverse("reports-list"), {"ordering": "-from_date"}, format="json"
        )
        json_data = response.json()
...
class TestReportCurrencyViews(APITestCase):
    def setUp(self):
        ...
        self.account3 = Account.objects.create(
            name="Test Account 3", currency=self.currency2, user=self.user
        )
    ...
    def test_api_create_report(self):
        ...
        response = self.client.post(
            reverse("reports-currency-list"), self.data, format="json"
        )
    ...
    def test_api_lists_and_sorts_reports_by_from_date(self):
        ...
        response = self.client.get(
            reverse("reports-currency-list"), {"ordering": "-from_date"}, format="json"
        )
        json_data = response.json()
