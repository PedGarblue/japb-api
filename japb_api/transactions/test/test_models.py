...
from japb_api.transactions.factories import (
    TransactionFactory,
    CategoryFactory,
    ExchangeComissionFactory,
)
...
class TestExchangeCommision(TestCase):
    ...
    def test_exchange_comission_fields(self):
        ...
        exchange_comission = ExchangeComissionFactory(
            account=self.account, exchange_from=exchange1, exchange_to=exchange2
        )
...
class TestTransactionCategoryModel(TestCase):
    ...
    def test_category_with_parent_category(self) -> None:
        ...
        category = CategoryFactory(
            name="test category", parent_category=parent_category
        )
